...
<div class="cartclcltn">
<a type="button" href="{{route('viewcartitems')}}">Cart({{Cart::content()->count()}})</a>
</div>
<div class="crticn">
  <i class='fas fa-shopping-cart' style='font-size:24px;color:blue'></i></div>
<div class="prcdctply">
  @yield('content')
...
<body>
<center><h1>Hi,{{$Loggeduserinfo->name}},Welcome to dashboard</h1>
<h3>You have accessed the Userdashboard,Welcome</h3>
